...
def sentence_similarity(simularity_pairs: list[list[str]], sentence1:str, sentence2: str) -> bool: 
    ...
    def find(find_str: str):
        if find_str not in simularity_dict:
            return find_str
        if simularity_dict[find_str] != find_str:
            simularity_dict[find_str] = find(simularity_dict[find_str])
    ...
    for pairs in simularity_pairs:
        ...
        if str1 not in simularity_dict:
            simularity_dict[str1] = str1

        if str2 not in simularity_dict:
...
#10:03 Tests
# Test 1: Failed Originally, Passed at 10:10 
...
sentence2_1 = ["I","love","leetcode"]
sentence2_2 = ["I","love","onepiece"]
similarPairs2 = [["manga","onepiece"],["platform","anime"],["leetcode","platform"],["anime","manga"]]
print(sentence_similarity(similarPairs2, sentence2_1, sentence2_2))
#Finished and tests pass at 10:12
