...
the shortest length and has all sequences[i] as subsequences. There could be multiple valid supersequences for the given array sequences.
...
Input: nums [int] permutation of 1, n, sentencees = [[]] (subsequence of nums)
Output: Boolean for if shortest supersequence 
'''