...
class Robot:
   ...
   def clean(self):
    ...
    Output: Nothing 
    Constraint:
        1. Don't know the size of the grid/ Where you are 
            Robot is in number line ? 
                    x    x  -1.  x  x
                -2   -1   0   1   2   
                    x    x    1  x   x
        2. We know if the cell has been visited based on our coordinate system. Maybe we get back to wherever Our 0 0 is
